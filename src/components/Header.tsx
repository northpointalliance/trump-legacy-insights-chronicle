    ...
    <header className={cn("w-full bg-trump-blue text-white py-4 shadow-md", className)}>
      <div className="container flex flex-col md:flex-row items-center justify-between">
        ...
        <nav className="flex flex-wrap space-x-2 md:space-x-6">
          ...
          <a href="/#foreign-travelers" className="hover:text-trump-red transition-colors duration-200 flex items-center px-2 py-1">
            <Map className="mr-1 h-4 w-4" /> Travel Decline
          </a>
          ...
          <Link to="/trump-x-posts" className="hover:text-trump-red transition-colors duration-200 flex items-center px-2 py-1">
            <MessageSquareX className="mr-1 h-4 w-4" /> X Posts
          </Link>
